 ...
 */
?>
<link rel="stylesheet" href="assets/usuarios_sidebar.css">
...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a class="nav-item <?php echo ($current_page === 'perfil') ? 'nav-item--active' : ''; ?>" href="index.php?route=usuarios">
    ...
    <a class="nav-item <?php echo ($current_page === 'rutina') ? 'nav-item--active' : ''; ?>" href="index.php?route=usuarios_rutina">
      <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <a class="nav-item <?php echo ($current_page === 'dieta') ? 'nav-item--active' : ''; ?>" href="index.php?route=usuarios_dieta">
      <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <a class="nav-item <?php echo ($current_page === 'maquinas') ? 'nav-item--active' : ''; ?>" href="index.php?route=usuarios_maquinas">
      <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
    ...
    <a class="nav-item <?php echo ($current_page === 'ejercicios') ? 'nav-item--active' : ''; ?>" href="index.php?route=usuarios_ejercicios">
      <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
